...
function MenuPrincipal() {
    ...
    const handleCloseUserMenuGoogle = () => {
        signInWithGoogle();
        setAnchorElUser(null);
    };

    const handleCloseUserMenuGitHub = () => {
        signInWithGitHub();
        setAnchorElUser(null);
    };
                        ...
                        <Box sx={{ flexGrow: 0 }}>
                            <Tooltip title="Menu do usuário">
                                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}
                                    ...
                                    <Typography >{!user ? "Autenticar" : <> {user?.email} </>}</Typography>
                            ...
                            <Menu
                                ...
                                onClose={handleCloseUserMenuGitHub}
                            >
                                {user ? (
                                    <div>
                                        <MenuItem
                                    ...
                                    <div>
                                        <MenuItem
                                            onClick={handleCloseUserMenuGoogle}
                                            component={NavLink}
                                            to="/"
                                            sx={{ display: 'flex', alignItems: 'center' }}
                                        >
                                            <GoogleIcon sx={{ marginRight: 1 }} />
                                            <Typography textAlign="center">Efetuar Login com Google</Typography>
                                        </MenuItem>
                                        <MenuItem
                                            onClick={handleCloseUserMenuGitHub}
                                            component={NavLink}
                                            to="/"
                                            sx={{ display: 'flex', alignItems: 'center' }}
                                        >
                                            <GitHubIcon sx={{ marginRight: 1 }} />
                                            <Typography textAlign="center">Efetuar Login com GitHub</Typography>
                                        </MenuItem>
                                    </div>
                                )}
                            </Menu>
